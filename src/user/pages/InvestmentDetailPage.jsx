...
import { useInvestment, money } from "@/user/api";
import { EasyXCard, EasyXStatusBadge, EasyXLoader, EasyXEmptyState } from "@/design/EasyX";
import { syncServerTime } from "@/components/landing/DiamondInvestmentCard";
...
function useCountdown(maturityAt, status, serverTime) {
  if (serverTime) {
...
export default function InvestmentDetailPage() {
  ...
  const remaining = useCountdown(inv?.maturity_at, inv?.status, inv?.server_time);
